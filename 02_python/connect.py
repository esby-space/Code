...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            # Parse response list
            rec_list_ = link.rx_obj(
                obj_type=type(list_), obj_byte_size=list_size, list_format="i"
            )

            # Parse response string
            rec_str_ = link.rx_obj(
                obj_type=type(str_), obj_byte_size=str_size, start_pos=list_size
            )

            # Parse response float
            rec_float_ = link.rx_obj(
                obj_type=type(float_),
